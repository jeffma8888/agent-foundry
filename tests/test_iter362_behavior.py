...
# Every verb the CLI is allowed to expose after this bite (Acceptance Criteria:
# "the same 57-verb set"). Counted, not enumerated, so the check stays about the
# INVARIANT rather than re-typing a table the census already owns.
EXPECTED_VERB_COUNT = 57
